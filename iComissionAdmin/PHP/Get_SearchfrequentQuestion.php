...
$sql= "select MAX(ViewCount) AS ViewCount FROM forumquestion"; 
        ...
        $Threshold = ($value->ViewCount/2);

        //echo $value->ViewCount;
        //echo $Top;

  $sql0 = "SELECT * FROM  forumquestion where ViewCount >= $Threshold  order by QuestionDate";
