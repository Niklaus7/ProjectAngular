...
$FinalProjectType = implode(" or ",$ProjType);
    ...
    $sql1="SELECT * FROM projectpost where ProjectName LIKE '%$ProjectName%' and ProjectLocation LIKE '%$ProjectLocation%' and ($FinalProjectType) and AssignmentActive = 'Active' and ProjectBudget BETWEEN '$MinBudget' AND '$MaxBudget' order by ProjectDateTime  DESC ";
    //echo $sql1;
