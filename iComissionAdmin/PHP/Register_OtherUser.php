...
//$stmt0->bind_param("isssssisss",$RoleType,$AuthPersonName,$UserAccountcol,$AuthPersonEmail,$Password,$gender,$AuthPersonPhone,$registrationdate,$IsActive,$ApprovedStatus);
//if($stmt0->execute()){
	...
	{
        $RoleType = $row["UserTypeID"];
        $AuthPersonName =  $row["FirstName"];
        $AuthPersonEmail =  $row["UserName"];
        $AuthPersonPhone =  $row["ContactNo"];
	}
        ...
        $stmt1->bind_param("issssssssssssssssssiss",$UserAccountID,$AuthPersonName,$AuthPersonPhone,$AuthPersonEmail,
                                    $Industry,$CompanyName,$CompanyAddress,$CompanyEmail,$CompanyWebsite,
                                    $FileData_file,$CompanyRegNo,$Date,$FileData_file1,$Country,$State,$PAN,$TAN,$Lat,$Lng,$Complete,$Aboutcompany,$officelocation);
                              //      echo $stmt1->error;
        if($stmt1->execute()){
        ...
        {
            echo $UserAccountID;//$stmt1->error;//"errdfgor"; //error message
        }
?>