...
$sql= "select MAX(AnswerCount) AS AnswerCount FROM forumquestion"; 
        ...
        $Threshold = ($value->AnswerCount/2);

        //echo $value->ViewCount;
        //echo $Top;

  $sql0 = "SELECT * FROM  forumquestion where AnswerCount >= $Threshold  order by QuestionDate";
