...
if($conn->query($sql1))
{
    $sql2 = "UPDATE membershipplanfeatures 
                                            set `UnlockRewards`= $UnlockRewards,
                                                ...
                                                `PreferredAssignmentSeekerEligible`=$PreferredAssignmentSeekerEligible, 
                                                `FreeProjectExtensions`=$FreeProjectExtensions, 
                                                `HighValueProjectBidding`=$HighValueProjectBidding,  
                                                `FreeSealedProjects`=$FreeSealedProjects,
                                                `FreeNDAProjects` =$FreeNDAProjects, 
                                                `UnlimitedEmployerFollowings`=$UnlimitedEmployerFollowings,
                                                `UnlimitedExternalInvoicing`=$UnlimitedExternalInvoicing
