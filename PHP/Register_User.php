...
if($stmt0->execute()){
    ...
    $EmailID = $Email;
    $subject = "ProcStart registeration completed";
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style='font-family:Helvetica,arial,sans-serif;font-size:14.5px;color:#666666;text-align:left;line-height:20px;border-collapse:collapse' align='left'>
                                                                            Thanks for getting started with Procstart! To continue with procstart complete your jobseeker profile first using your credentials and start searching for your dream job accross your industry.
